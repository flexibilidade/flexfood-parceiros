  ...
  return (
    <div className="py-6 space-y-6">
      ...
      <div className="flex justify-between items-center flex-wrap gap-4">
        <div>
          <h1 className="text-lg font-bold">Finanças e Relatórios</h1>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-lg font-bold">{overview?.totalRevenue.toFixed(2)} MT</div>
            {comparison && (
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-lg font-bold">{overview?.totalOrders}</div>
            {comparison && (
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-lg font-bold">{overview?.averageOrderValue.toFixed(2)} MT</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-lg font-bold">{overview?.cancelledOrders}</div>
